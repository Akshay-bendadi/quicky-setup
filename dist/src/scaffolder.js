...
function createFolders(projectPath, framework) {
    const folders = [
        "public",
    ];
    if (framework === "next") {
        // For Next.js, only create folders that don't conflict with app directory structure
        folders.push("components", "hooks", "lib", "styles", "types", "store", "services");
    }
    else if (framework === "react") {
        // For React (Vite/React), use src/ structure
        folders.push("src/components", "src/hooks", "src/layouts", "src/services", "src/store", "src/styles", "src/utils", "src/pages", "src/routes");
    }
    else {
        // Fallback for other frameworks
        folders.push("src/components", "src/hooks", "src/layouts", "src/services", "src/store", "src/styles", "src/utils");
    }
...
export default defineConfig({
  plugins: [
    ...
    createFolders(projectPath, answers.framework);
    // Readme and git init
    fs.writeFileSync(path.join(projectPath, "README.md"), `# ${answers.projectName}\n\nGenerated by [quicky-setup](https://github.com/your-org/quicky-setup) 🚀\n`);
